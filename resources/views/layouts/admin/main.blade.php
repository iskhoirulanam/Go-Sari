...
<html lang="en">
  ...
  <link rel="stylesheet" href="../modules/weathericons/css/weather-icons.min.css">
  <link rel="stylesheet" href="../modules/weathericons/css/weather-icons-wind.min.css">
  ...
  <body>
    ...
    <!-- <script src="{{ asset('js/admin/page/index-0.js') }}"></script> -->
    <script src="{{ asset('js/admin/page/modules-sweetalert.js') }}"></script>
    @yield('script')
  </body>
